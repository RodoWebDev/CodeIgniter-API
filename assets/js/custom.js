$(document).ready(function() {
  ...
  $(".content-wrapper").on("click",".modalButtonEntite", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'AdminEntite/get_entite',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_entite').find('.modal-body').html(data);
      $('#nameModal_entite').modal('show'); 
    })
  });

  $(".content-wrapper").on("click",".modalButtonUser", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'AdminUser/get_user',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
