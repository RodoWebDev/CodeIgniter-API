          <footer class="main-footer">This project is created by Olive</footer>
    <!-- /.control-sidebar -->
...
<script>
    ...
    function set_interval() {
        timer = setInterval("auto_logout()", 1200000); //120s log out
    }
    ...
    function selectRow(obj){
        ...
        if ($(obj).prop("checked")) {
            $(row).css('background-color', 'rgb(255, 186, 255)');
        }   else {
